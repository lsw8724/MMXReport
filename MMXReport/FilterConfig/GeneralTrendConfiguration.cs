...
namespace MMXReport
{
    public class GeneralTrendConfiguration : BaseConfiguration
    {
        public double MaxScale2 { get; set; }
        public int ScaleTypeIdx2 { get; set; }
        public string AlarmReferenceName2 { get; set; }

        public double MaxScale3 { get; set; }
        public int ScaleTypeIdx3 { get; set; }
        public string AlarmReferenceName3 { get; set; }
        ...
        public GeneralTrendConfiguration()
        {
            StatTermType = "day";
